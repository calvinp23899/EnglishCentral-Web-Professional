...
type ColumnKey = "code" | "name" | "course" | "teacher" | "startDate" | "status";
...
const labels: Record<ColumnKey, string> = { code: "Mã lớp", name: "Tên lớp", course: "Khóa học", teacher: "Nhân viên", startDate: "Ngày bắt đầu", status: "Trạng thái" };
