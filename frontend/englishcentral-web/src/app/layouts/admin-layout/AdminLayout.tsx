...
const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Nguồn Lead", path: "/admin/crm-sales/lead-sources" },
      { label: "Hoạt động Lead", path: "/admin/crm-sales/lead-activities" },
      { label: "Chuyển đổi Lead", path: "/admin/crm-sales/lead-conversions" },
    ],
  },
  {
    label: "Cost / Expense",
...
const breadcrumbLabels: Record<string, string> = {
  ...
  "lead-conversions": "Chuyển đổi Lead",
