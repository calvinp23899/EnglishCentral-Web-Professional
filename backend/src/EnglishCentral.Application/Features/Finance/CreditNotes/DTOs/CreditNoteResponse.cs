...
{
    public record CreditNoteResponse(Guid PublicId, long Id, long StudentId, long? EnrollmentId, long? InvoiceId, string CreditNoteNo, decimal Amount, decimal AppliedAmount, decimal RemainingAmount, ECreditNoteStatus Status, string Reason, DateTimeOffset IssuedAt, string? Notes);
