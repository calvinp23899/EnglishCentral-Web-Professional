...
{
    public record RefundResponse(Guid PublicId, long Id, long PaymentId, long? EnrollmentId, string RefundNo, decimal Amount, ERefundStatus Status, ERefundMethod Method, string Reason, DateTimeOffset RequestedAt, DateTimeOffset? RefundedAt, string? ReferenceCode, string? Notes);
