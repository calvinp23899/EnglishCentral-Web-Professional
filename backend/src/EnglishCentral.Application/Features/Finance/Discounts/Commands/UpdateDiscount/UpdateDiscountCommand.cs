...
{
    public record UpdateDiscountCommand(long Id, string Code, string Name, DiscountType Type, decimal Value, DateOnly? ValidFrom, DateOnly? ValidTo, bool IsActive, string? Description) : IRequest<Result<DiscountResponse>>;
