...
{
    public record CreateDiscountCommand(string Code, string Name, DiscountType Type, decimal Value, DateOnly? ValidFrom, DateOnly? ValidTo, bool IsActive, string? Description) : IRequest<Result<DiscountResponse>>;
