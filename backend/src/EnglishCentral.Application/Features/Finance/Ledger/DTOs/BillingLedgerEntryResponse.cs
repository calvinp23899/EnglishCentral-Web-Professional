...
{
    public record BillingLedgerEntryResponse(Guid PublicId, long Id, long? EnrollmentId, long? InvoiceId, long? PaymentId, long? PaymentAllocationId, long? RefundId, long? CreditNoteId, BillingLedgerEntryType Type, decimal DebitAmount, decimal CreditAmount, decimal BalanceAfter, DateTimeOffset OccurredAt, string? Description);
